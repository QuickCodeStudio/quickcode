...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeStudio/quickcode.git
  ```
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/quickcode)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://quickcode-gateway.quickcode.net](https://quickcode-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://quickcode-portal.quickcode.net](https://quickcode-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://quickcode-gateway.quickcode.net](https://quickcode-gateway.quickcode.net)
- **Portal:**
    - link: [https://quickcode-portal.quickcode.net](https://quickcode-portal.quickcode.net)
- **Module APIs:**
    - link: [https://quickcode-identity-module.quickcode.net](https://quickcode-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["quickcode-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://quickcode-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-08-19 19:51:57 UTC]