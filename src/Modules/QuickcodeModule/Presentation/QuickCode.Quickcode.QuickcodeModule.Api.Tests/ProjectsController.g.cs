...
namespace QuickCode.Quickcode.QuickcodeModule.Api.Tests
{
    public class ProjectsControllerTests
    {
        ...
        public async Task ListAsync_Should_Return_Ok_When_Success()
        {
            ...
            var fakeResult = new ListResult<ProjectDto>
            {
                Items = fakeList
            };
            _serviceMock.Setup(s => s.ListAsync(It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<bool>())).ReturnsAsync(new Response<ListResult<ProjectDto>> { Code = 0, Value = fakeResult });
            // Act
        ...
        {
            // Arrange
            _serviceMock.Setup(s => s.ListAsync(It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<bool>())).ReturnsAsync(new Response<ListResult<ProjectDto>> { Code = 1, Message = "Error" });
            // Act
            var result = await _controller.ListAsync(1, 10);
            // Assert
        ...
        public async Task GetItemAsync_Should_Return_Ok_When_Found()
        {
            ...
            _serviceMock.Setup(s => s.GetItemAsync(It.IsAny<Guid>())).ReturnsAsync(new Response<ProjectDto> { Code = 0, Value = fakeDto });
            // Act
        ...
        public async Task GetItemAsync_Should_Return_NotFound_When_404()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<ProjectDto>("tr");
            _serviceMock.Setup(s => s.GetItemAsync(It.IsAny<Guid>())).ReturnsAsync(new Response<ProjectDto> { Code = 404, Message = "Not found" });
            // Act
            var result = await _controller.GetItemAsync(fakeDto.Id);
            // Assert
            Assert.IsType<NotFoundObjectResult>(result);
        ...
        public async Task GetItemAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<ProjectDto>("tr");
            _serviceMock.Setup(s => s.GetItemAsync(It.IsAny<Guid>())).ReturnsAsync(new Response<ProjectDto> { Code = 1, Message = "Error" });
            // Act
            var result = await _controller.GetItemAsync(fakeDto.Id);
            // Assert
        ...
        public async Task UpdateAsync_Should_Return_Ok_When_Success()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<ProjectDto>("tr");
            _serviceMock.Setup(s => s.UpdateAsync(It.IsAny<Guid>(), It.IsAny<ProjectDto>())).ReturnsAsync(new Response<bool> { Code = 0, Value = true });
            // Act
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_404()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<ProjectDto>("tr");
            _serviceMock.Setup(s => s.UpdateAsync(It.IsAny<Guid>(), It.IsAny<ProjectDto>())).ReturnsAsync(new Response<bool> { Code = 404, Message = "Not found" });
            // Act
            var result = await _controller.UpdateAsync(fakeDto.Id, fakeDto);
            // Assert
            Assert.IsType<NotFoundObjectResult>(result);
        ...
        public async Task UpdateAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<ProjectDto>("tr");
            _serviceMock.Setup(s => s.UpdateAsync(It.IsAny<Guid>(), It.IsAny<ProjectDto>())).ReturnsAsync(new Response<bool> { Code = 1, Message = "Update failed" });
            // Act
            var result = await _controller.UpdateAsync(fakeDto.Id, fakeDto);
            // Assert
            Assert.IsType<BadRequestObjectResult>(result);
